...
tf.flags.DEFINE_string("brain_save_dir",'bridge_models/embeddings/', 'where to save embeddings')
...
if __name__ == '__main__':
  ...
  # Explain Brain object with no mapper and no encoder
  print("4. initialize Explainer...")
  explain_brain = ExplainBrain(hparams, brain_data_reader, None, None)
  ...
  saving_dic = {'time_steps':time_steps, 'start_steps':start_steps, 'end_steps':end_steps,
                'brain_activations': brain_activations, 'stimuli':stimuli}
