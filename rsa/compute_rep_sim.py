...
def read_embeddings(a, blocks, selecting_feature, context_mode, selected_steps):
  ...
  for b in blocks:
    ...
    return list(np.asarray(a['encoded_stimuli'][b])[selected_steps[b][embedding_key + context_mode]]), selected_steps
...
if __name__ == '__main__':
  ...
  selecting_feature = 'quote' # none | end | ch | quote
  ...
  for encoder_type in encoder_types:
    for embedding_type in embedding_types[encoder_type]:
      ...
      embedded_steps, selected_steps = read_embeddings(a,blocks, selecting_feature,
                                                       context_mode="_none", selected_steps=selected_steps)
  ...
  dic2save = {"klz": klz,
              ...
              "labels_": labels_,
              "p_vals": p_vals}
  np.save("rsa_results_all_full_brain_"+str(delay)+"_"+selecting_feature, dic2save)
